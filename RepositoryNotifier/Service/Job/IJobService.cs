...
namespace RepositoryNotifier.Service.Job
{
    ...
    {
        Persistence.Job.Job CreateJob(CreateRepositoryInspectorJobTO p_repositoryInspectorJob);
        ...
        bool UpdateJob(UpdateRepositoryInspectorJobTO p_repositoryInspectorJob);
